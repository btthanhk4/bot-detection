...
def save_detection_result(telemetry: dict, analysis: dict) -> Optional[str]:
    ...
    try:
        ...
        doc = {
            ...
            "decision_state": str(analysis.get("decision_state") or "FINAL")[:32],
            "score_calibrated": analysis.get("score_calibrated") is True,
            "policy_version": str(analysis.get("policy_version") or "")[:32],
            "is_bot": verdict == "BOT",
